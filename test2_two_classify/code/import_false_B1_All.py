...
os.chdir('../data/input_false_B1All/')# 改变当前工作目录。注意路径的分隔符
...
np.savetxt('../output_false_B1All/output.csv', result_matrix, delimiter=",")# 将数组存储到output中
b = np.loadtxt('../output_false_B1All/output.csv', delimiter=",") # 读取数组（读得数据为数组形式）
print(b)
