...
os.chdir('../data/input_B5/')  # 改变当前工作目录。注意路径的分隔符
...
result_matrix[:, 1000] = 5  # 写标签

# print(result_matrix)

np.savetxt('../output_B5/output.csv', result_matrix, delimiter=",")  # 将数组存储到output中
b = np.loadtxt('../output_B5/output.csv', delimiter=",")  # 读取数组（读得数据为数组形式）
print(b)
